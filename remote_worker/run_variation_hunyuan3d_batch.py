...
def main() -> int:
    ...
    parser.add_argument("--python", default="/root/miniconda3/envs/hunyuan3d21/bin/python")
    ...
    parser.add_argument("--hy21-python", default="/root/miniconda3/envs/hunyuan3d21/bin/python")
