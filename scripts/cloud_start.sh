...
WORKER_PYTHON="${FLOWSTUDIO_WORKER_PYTHON:-/root/autodl-tmp/venvs/torch5090/bin/python}"
...
START_VLM="${FLOWSTUDIO_START_VLM:-1}"
VLM_URL="${IUL_VLM_INTENT_URL:-http://127.0.0.1:18081/intent/interpret}"
QWEN_IMAGE_URL="${CF_QWEN_IMAGE_URL:-http://127.0.0.1:18082/generate}"
